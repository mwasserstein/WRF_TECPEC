...
# Boundaries
top_latitude = 40.84
bottom_latitude = 40.09
left_longitude = -113.03
right_longitude = -111.38
...
save_path = Fig_dir + f'WRF_Synoptic_precip_accum_scatt_d0{domain}_{time_start}_{time_end}_small_domain.png'
...
# Add a title
ax.set_title("WRF{} Run {} d0{}\nInit {}".format(domain, path, run, init_time_str), fontsize = 10, loc = 'left',)
...
################################################################################
# Path for saving figure
save_path = Fig_dir + f'WRF_Synoptic_precip_accum_text_d0{domain}_{time_start}_{time_end}_small_domain.png'
print(save_path)
...
# Add colorbar
cax = plt.axes([0.14,0.15, 0.75, 0.025])
plt.colorbar(im, cax = cax, orientation = 'horizontal', label = 'Precipitation accumulation (mm)', ax = ax, fraction = 0.05,
             ticks = levels[::8], drawedges=True)
